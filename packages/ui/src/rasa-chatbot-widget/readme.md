...
| `errorMessage`            | `error-message`             | Message that should be displayed if an error occurs                                                    | `string`  | `'Algo de ruim aconteceu'`   |
| `initialPayload`          | `initial-payload`           | Data that should be sent on Chat Widget initialization                                                 | `string`  | `''`                         |
| `inputMessagePlaceholder` | `input-message-placeholder` | Message placeholder for input                                                                          | `string`  | `'Insira sua mensagem aqui'` |
...
| `widgetTitle`             | `widget-title`              | Title of the Chat Widget                                                                               | `string`  | `'PNLD Chatbot'`             |
